...
<html lang="en">
    <!-- HNQ -->
<head>
        <title>Quản lý Olympia GYM Club </title><meta charset="UTF-8" />
    ...
    <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="POST" action="#">
				 <div class="control-group normal_text"> <h3>Đăng nhập dành cho khách hàng</h3></div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span><input type="text" name="user" placeholder="Tên đăng nhập" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="form-actions">
                    <span class="pull-left"><a href="#" class="flip-link btn btn-info" id="to-recover">Đăng ký</a></span>
                    <span class="pull-right"><button type="submit" name="login" class="btn btn-success" />Đăng nhập KH</button></span>
                </div>
                <div class="g">
                <a href="../index.php"><h6>Quay lại</h6></a>
                </div>
            ...
            <form id="recoverform" action="../customer/pages/register-cust.php" method="POST" class="form-vertical">
				<p class="normal_text">Enter your details below and we will send your details for further activation process.</p>
                    ...
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lo"><i class="icon-pencil"></i></span><input type="text" name="fullname" placeholder="Ghi đầy đủ họ tên" />
                        </div>
                    </div>
                ...
                <br>
                    ...
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lo"><i class="icon-asterisk"></i></span><input type="text" name="address" placeholder="Nhập địa chỉ" />
                        </div>
                    </div>
                        ...
                        <div class="controls">
                            ...
                            <option selected="true" disabled="disabled">Select Service</option>
                                <option value="Fitness" >Gói 1</option>
                                <option value="Sauna">Gói 3</option>
                                <option value="Cardio">Gói 3</option>
                            </select>
                            </div>
                        </div>
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><button class="btn btn-info" type="SUBMIT">Xác nhận</button></span>
                </div>

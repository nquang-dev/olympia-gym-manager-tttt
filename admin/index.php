  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_ls span"> <a href="index.php" style="font-size: 16px;"> <i class="fas fa-user-check"></i> <span class="label label-important"><?php include'actions/dashboard-activecount.php'?></span> Hội viên tích cực</a> </li>
        <li class="bg_lo span3"> <a href="members.php" style="font-size: 16px;"> <i class="fas fa-users"></i></i><span class="label label-important"><?php include'dashboard-usercount.php'?></span> Hội viên đã đăng ký </a> </li>
        <li class="bg_lg span3"> <a href="payment.php" style="font-size: 16px;"> <i class="fa fa-dollar-sign"></i> Tổng thu nhập:  <?php include'income-count.php' ?> VND</a> </li>
        <li class="bg_lb span2"> <a href="announcement.php" style="font-size: 16px;"> <i class="fas fa-bullhorn"></i><span class="label label-important"><?php include'actions/count-announcements.php'?></span>Thông báo </a> </li>
...
<!--Chart-box-->    
      ...
      <div class="widget-box">
        ...
        <div class="widget-content" >
          <div class="row-fluid">
            ...
            <div class="span4">
              <ul class="site-stats">
                <li class="bg_lh"><i class="fas fa-users"></i> <strong><?php include 'dashboard-usercount.php';?></strong> <small>Số lượng hội viên</small></li>
                <li class="bg_lg"><i class="fas fa-user-clock"></i> <strong><?php include 'actions/dashboard-staff-count.php';?></strong> <small>Số lượng nhân viên</small></li>
                <li class="bg_ls"><i class="fas fa-dumbbell"></i> <strong><?php include 'actions/count-equipments.php';?></strong> <small>Thiết bị có sẵn</small></li>
                <li class="bg_ly"><i class="fas fa-file-invoice-dollar"></i> <strong>Giá: <?php include 'actions/total-exp.php';?></strong> <small>Tổng Chi phí</small></li>
                <li class="bg_lr"><i class="fas fa-user-ninja"></i> <strong><?php include 'actions/count-trainers.php';?></strong> <small>PT</small></li>
                <li class="bg_lb"><i class="fas fa-calendar-check"></i> <strong><?php include 'actions/count-attendance.php';?></strong> <small>Thành viên hiện tại</small></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="row-fluid">
      <div class="widget-box">
        <div class="widget-title bg_lg"><span class="icon"><i class="fas fa-file"></i></span>
          <h5>Báo cáo thu nhập và Chi Phí</h5>
        </div>
        <div class="widget-content" >
          <div class="row-fluid">
            <div class="span12">
    ...
    <div class="row-fluid">
      <div class="span6">
        <div class="widget-box">
          <div class="widget-title bg_ly" data-toggle="collapse" href="#collapseG2"><span class="icon"><i class="fas fa-chevron-down"></i></span>
            <h5>Biểu đồ hội viên đăng ký theo: Giới tính</h5>
          </div>
      ...
      <div class="span6">
        <div class="widget-box">
          <div class="widget-title bg_ly" data-toggle="collapse" href="#collapseG2"><span class="icon"><i class="fas fa-chevron-down"></i></span>
            <h5>Nhân viên theo chức danh</h5>
          </div>
          <div class="widget-content nopadding collapse in" id="collapseG2">
            <ul class="recent-posts">
    ...
    <div class="row-fluid">
            ...
            <ul class="recent-posts">
              ...
              <?php
                ...
                while($row=mysqli_fetch_array($result)){
                  ...
                  echo"<span class='user-info'> Thông báo bởi: Admin Olympia GYM / Ngày: ".$row['date']." </span>";
              ...
              <a href="manage-announcement.php"><button class="btn btn-warning btn-mini">Xem tất cả</button></a>
              </li>
            </ul>
          </div>
        </div><!-- HNQ -->
      ...
      <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="fas fa-tasks"></i></span>
            <h5>Danh sách việc cần làm của khách hàng</h5>
          </div>
          <div class="widget-content">
            <div class="todo">
              <ul>
...
<script src="../js/excanvas.min.js"></script> <!-- HNQ -->

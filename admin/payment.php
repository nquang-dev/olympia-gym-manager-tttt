...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Thanh Toán<i class="fas fa-group"></i></h1>
  </div>
          ...
          echo"<table class='table table-bordered data-table table-hover'>
              <thead>
                <tr>
                  <th>#</th>
                  <th>Hội Viên</th>
                  <th>Ngày thanh toán cuối cùng</th>
                  <th>Số tiền</th>
                  <th>Dịch vụ/Khóa học</th>
            ...
            <tbody> 
                ...
                <td><div class='text-center'><a href='user-payment.php?id=<?php echo $row['user_id']?>'><button class='btn btn-success btn'><i class='fas fa-dollar-sign'></i> Thanh toán</button></a></div></td>
                <td><div class='text-center'><a href='sendReminder.php?id=<?php echo $row['user_id']?>'><button class='btn btn-danger btn' <?php echo($row['reminder'] == 1 ? "disabled" : "")?>>Nhắc</button></a></div></td>
              </tbody>
          <?php $cnt++; }

...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="member-status.php" class="current">Trạng Thái </div>
    <h1 class="text-center">Trạng Thái Hội Viên <i class="fas fa-eye"></i></h1>
  </div>

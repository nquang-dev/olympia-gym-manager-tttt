...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">From Đăng ký nhân viên <i class="fas fa-briefcase"></i></h1>
  </div>
          ...
          <div class="widget-content nopadding">
            <form id="form-wizard" action="added-staffs.php" class="form-horizontal" method="POST">
              ...
              <div class="control-group">
                ...
                <div class="control-group">
                  <label class="control-label">Tên đăng nhập nhân viên</label>
                  <div class="controls">
              ...
              <div id="form-wizard-2" class="step">
                ...
                <div class="control-group">
                  ...
                  <option value="Tap vu">Tạp vụ</option>
                    ...
                    <option value="Tu van GYM">Tư vấn GYM</option>
                    <option value="Tu van Yoga">Tư vấn Yoga</option>

...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="customer-progress.php" class="current">Cập Nhật Tiến Độ Hội Viên</a> </div>
    <h1 class="text-center">Cập Nhật Tiến Độ Hội Viên <i class="fas fa-signal"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'>".$row['plan']." Tháng</div></td>
                <td><div class='text-center'><a href='update-progress.php?id=".$row['user_id']."'><button class='btn btn-warning btn'> Cập nhật tiến độ</button></a></div></td>

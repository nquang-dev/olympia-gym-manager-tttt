    ...
    <div class="row-fluid">
     ...
     <div class="widget-content">
                ...
                <table class="table table-bordered table-invoice-full">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><div class="text-center"><?php echo $row['plan']; ?> Tháng</div></td>
                    </tr>
                  </tbody>
                </table>
                <table class="table table-bordered table-invoice-full">
            ...
            <div class="row-fluid">
                ...
                <h4>GYM Hội viên:  <?php echo $row['fullname']; ?> <br> Weight Variation of <em style="color:green"><?php include 'actions/progress-percent.php';?>%</em> as per current updates! <i class="fa fa-spinner fa-spin" style="font-size:24px"></i><br/> <br/>  <br/></h4><p>Cảm ơn bạn đã sử dụng dịch vụ của Olympia GYM Club!<br/>Chúc bạn một ngày tốt lành</p>
                </div>

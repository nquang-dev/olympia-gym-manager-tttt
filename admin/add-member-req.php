  ...
  echo"<div class='container-fluid'>";
      ...
      echo"<div class='widget-title'> <span class='icon'> <i class='fas fa-info'></i> </span>";
          ...
          echo"<div class='widget-content'>";
              ...
              echo"<h3>Hội viên đã được thêm vào</h3>";
              echo"<p>Nhấp vào nút bên dưới để quay lại trang</p>";
              echo"<a class='btn btn-inverse btn-big'  href='members.php'>Quay lại</a> </div>";
          echo"</div>";
          echo"</div>";
      echo"</div>";
      echo"</div>";

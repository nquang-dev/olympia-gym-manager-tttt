...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="remove-equipment.php" class="current">Xóa Thiết Bị</a> </div>
    <h1 class="text-center">Xóa Thiết Bị <i class="fas fa-cogs"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='actions/delete-equipment.php?id=".$row['id']."' style='color:#F66;'><i class='fas fa-trash'></i> Xóa</a></div></td>

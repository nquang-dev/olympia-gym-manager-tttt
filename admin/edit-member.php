...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Danh sách hội viên đăng ký<i class="fas fa-group"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='edit-memberform.php?id=".$row['user_id']."'><i class='fas fa-edit'></i> Sửa</a></div></td>

...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="services-report.php" class="current">Biểu đồ</a> </div>
    <h1 class="text-center">GYM Gói đăng ký <i class="fas fa-bar-chart"></i></h1>
  </div>

...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="#" class="tip-bottom">Thiết bị</a> <a href="#" class="current">Thêm Thiết bị</a> </div>
  <h1>Thêm Thiết Bị</h1>
</div>
        ...
        <div class="widget-content nopadding">
          <form action="add-equipment-req.php" method="POST" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="ename" placeholder="Tên thiết bị" required />
              </div>
            </div>
            <div class="control-group">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            ...
            <div class="control-group">
              <label class="control-label">Giá của thiết bị:  </label>
              <div class="controls">
                <div class="input-append">
                  <span class="add-on">VND</span> 
                  <input type="number" placeholder="100.000" name="amount" class="span11" required>
                  </div>
              </div>
            </div>

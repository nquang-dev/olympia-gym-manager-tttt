...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="reports.php" class="current">Biểu đồ</a> </div>
    <h1 class="text-center">Báo Cáo Thu Nhập Và Chi phí <i class="fas fa-chart-bar"></i></h1>
  </div>
  ...
  <div id="content-header">
    <h1 class="text-center">Hội Viên Đăng Ký <i class="fas fa-chart-bar"></i></h1>
  </div>
  <div class="container-fluid">
  ...
  <div id="content-header">
    <h1 class="text-center">Gói đăng ký <i class="fas fa-chart-bar"></i></h1>
  </div>
  <div class="container-fluid">

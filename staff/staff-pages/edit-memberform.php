...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Manamge Members</a> <a href="#" class="current">Thêm hội viên</a> </div>
          ...
          <form action="edit-member-req.php" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <span class="help-block">Lưu ý: Chỉ thành viên mới được phép thay đổi mật khẩu của mình cho đến khi và trừ khi đó là trường hợp khẩn cấp.</span>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="plan" required="required" id="select">
                  <option value="30" selected="selected" >Một tháng</option>
                  <option value="90">Ba tháng</option>
                  <option value="180">Sáu tháng</option>
          ...
          <div class="form-horizontal">
            ...
            <div class="form-actions text-center">
             ...
             <input type="hidden" name="id" value="<?php echo $row['user_id'];?>">
              <button type="submit" class="btn btn-success">Sửa thông tin hội viên</button>
            </div>
            </form>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
          <form>
            <div class="controls">
              <textarea class="textarea_editor span12" rows="6" placeholder="Nhập ..."></textarea>
            </div>
          </form>
        </div>
      </div>

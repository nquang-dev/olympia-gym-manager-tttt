...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="member-status.php" class="current">Trạng Thái </div>
    <h1 class="text-center">Trạng Thái Hội Viên <i class="icon icon-eye-open"></i></h1>
  </div>
          ...
          echo"<table class='table table-bordered table-striped'>
           ...
           <tbody> 
               ...
               <td><div class='text-center'><?php echo $cnt;?></div></td>
                ...
                <td><div class='text-center'><?php echo $row['plan'];?> ngày</div></td>

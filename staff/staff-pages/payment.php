...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Thanh Toán<i class="icon icon-group"></i></h1>
  </div>
  ...
  $result=mysqli_query($conn,$qry);
    ...
    echo"<table class='table table-bordered data-table table-hover'>
      ...
      <tbody> 
          ...
          <td><div class='text-center'><a href='user-payment.php?id=<?php echo $row['user_id']?>'><button class='btn btn-success btn'><i class='icon icon-money'></i> Thanh toán</button></a></div></td>

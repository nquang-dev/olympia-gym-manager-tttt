          ...
          <div class="widget-content">
              ...
              <div class="span7">
                <table class="table table-bordered table-invoice">
				  ...
				  <form action="userpay.php" method="POST">
                    <tr>
                    <tr>
                      <td class="width30">Tên đầy đủ hội viên: </td>
                ...
                <select name="plan" required="required" id="select">
                  ...
                  <td class="width30">Trạng thái hội viên: </td>
                    <td class="width70">
					<div class="controls">
            ...
            <div class="row-fluid">
             ...
             <input type="hidden" name="id" value="<?php echo $row['user_id'];?>">
                  ...
                  <button class="btn btn-success btn-large" type="SUBMIT" href="">Xác nhận thanh toán</button> 
				</div>

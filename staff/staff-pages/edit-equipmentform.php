...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Thiết bị</a> <a href="#" class="current">Edit Thiết bị</a> </div>
  <h1>Thêm Thiết Bị</h1>
</div>
